...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription: "A responsive web-based music player built entirely with React and styled using CSS/SCSS. This project demonstrates core proficiency in modern front-end development, specifically focusing on creating a smooth and interactive user experience.",
    ...findImage("project-2"), // Re-using an existing image
    status: "Completed",
